...
int main(void) {
  ...
  raylib::Rectangle boxB(GetScreenWidth() / 2 - 30, GetScreenHeight() / 2 - 30,
                         60, 60);
  ...
  raylib::Image icon = raylib::LoadImage("icon/icon.png");
  SetWindowIcon(icon);
